...
cells in the rat somatosensory cortex (manually traced from \cite{Romand2011}) \textbf{A} Axon morphology of a single cell (left), branch density heatmap of axons for 5 neurons with the soma aligned at the center. \textbf{B} As in A, but for dendrite.}
