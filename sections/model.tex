...
\begin{center}\vspace{0.3cm}
  \includegraphics[width=\columnwidth]{%
    figures/4_network_models.pdf}
  \captionof{figure}{Network models. \textbf{A-D} Targets of a single
    neuron (Id in bottom right corner) for the different network
    models. \textbf{E-F} Rewiring algorithm. \textbf{G-H}
